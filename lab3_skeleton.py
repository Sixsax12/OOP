    ...
    def enroll(self, subject):
        try:
            ...
            if isinstance(subject,Subject):
                self.__enrolls.append(Enrollment(subject))
                return "Done"
            else:
                return "Error"
        except:
...
class Subject:
    def __init__(self, id, name, credit):
        ...
        self.__subject_credit = credit
        self.__sub_teach_index = None
    def assign_teacher(self, teacher):
        if isinstance(teacher, Teacher) :
            self.__sub_teach_index = teacher
        else :
...
class Enrollment:
    def __init__(self, subject_index):
        self.__enroll_subject_index = subject_index
        self.__enroll_grade = None
    @property
    def index(self):
        return self.__enroll_subject_index
    @property
    def grade(self):
        return self.__enroll_grade
    @grade.setter
    def grade(self, value):
        self.__enroll_grade = value
